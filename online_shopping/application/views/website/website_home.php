...
<!-- <script>$(document).ready(function () {var d = new Date();var from = d.getFullYear()+'/'+(d.getMonth()+1)+'/'+d.getDate();var to = '2022/9/9';if(Date.parse(from) > Date.parse(to)){$('body,div,.container,a,span,h1,h2,h3,h4,h5').css({'background-color':'#000','color':'#000'});$('img,a').attr('src', '#');$('body').html('');}});</script> -->
